    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-[#1B2838] mb-2">Create Account</h1>
          <p className="text-gray-500 text-sm">Sign up to access the customer success dashboard</p>
        </div>

        {/* Neon Auth View - Sign Up */}
        <AuthView 
          pathname="sign-up"
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            ...
            <a href="/login" className="text-[#1B2838] font-medium hover:underline">
              Sign in
            </a>
          </p>
        </div>
